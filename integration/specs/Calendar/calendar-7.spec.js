...
describe('Calendar', () => {
    ...
    it('should navigate on the header when using arrow keys', () => {
        ...
        expect(calendar.isLeftMonthYearSelectFocused()).toBe(false);
        expect(calendar.isRightMonthYearSelectFocused()).toBe(false);
        ...
        expect(calendar.isLeftMonthYearSelectFocused()).toBe(true);
        expect(calendar.isRightMonthYearSelectFocused()).toBe(false);
        expect(calendar.isNextMonthButtonFocused()).toBe(false);
        browser.keys(ARROW_RIGHT_KEY);
        expect(calendar.isPrevMonthButtonFocused()).toBe(false);
        expect(calendar.isLeftMonthYearSelectFocused()).toBe(false);
        expect(calendar.isRightMonthYearSelectFocused()).toBe(true);
        expect(calendar.isNextMonthButtonFocused()).toBe(false);
        browser.keys(ARROW_RIGHT_KEY);
        expect(calendar.isPrevMonthButtonFocused()).toBe(false);
        expect(calendar.isLeftMonthYearSelectFocused()).toBe(false);
