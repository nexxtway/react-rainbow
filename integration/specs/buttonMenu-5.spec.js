const MENU_BTN_THREEDOTS_VERTICAL = '#rsg-root > div > main > section > section > div > div > article > div > article > div > div > div > div > header > div > div.rainbow-button-group.slds-m-right_medium > div > button';
