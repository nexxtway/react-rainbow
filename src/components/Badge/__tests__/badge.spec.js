...
describe('<Badge/>', () => {
    ...
    it('should have the right class names when variant is not passed', () => {
        const component = mount(<Badge label="Badge Label" />);
    ...
    it('should have the right class names when variant brand', () => {
        const component = mount(<Badge label="Badge Label" variant="brand" />);
    ...
    it('should have the right class names when variant outline-brand', () => {
        const component = mount(<Badge label="Badge Label" variant="outline-brand" />);
        expect(component.find('span.rainbow-badge.rainbow-badge--outline-brand').exists()).toBe(
            true,
        );
    });
    it('should have the right class names when variant lightest', () => {
        const component = mount(<Badge label="Badge Label" variant="lightest" />);
    ...
    it('should have the right class names when variant inverse', () => {
        const component = mount(<Badge label="Badge Label" variant="inverse" />);
