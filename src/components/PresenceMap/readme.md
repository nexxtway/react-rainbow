...
const PresenceMapExample = () => {
    ...
    const filteredMarkers = markers.filter(marker => carAvailabilityState.name === 'all' || (marker.available === (carAvailabilityState.name === 'availables')));
