...
import StyledCalendarsContainer from './styled/calendarsContainer';
import {
    UP_KEY,
    DOWN_KEY,
    RIGHT_KEY,
...
class DoubleCalendar extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <section id={id} className={className} style={style}>
                <StyledControlsContainer isDouble>
                    <StyledMonthContainer isDouble>
                        <StyledArrowButton
