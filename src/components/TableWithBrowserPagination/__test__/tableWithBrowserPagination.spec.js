...
describe('<TableWithBrowserPagination />', () => {
    it('should set the right class names when paginationAlignment is passed', () => {
        ...
        paginationAlignments.forEach((paginationAlignment, index) => {
    ...
    it('should show the Pagination when pageSize is less than data length', () => {
        const component = mount(
            <TableWithBrowserPagination keyField={'id'} data={data} pageSize={5} />,
        );
    ...
    it('should show the Select when the pages amount is greater than 6', () => {
        const component = mount(
            <TableWithBrowserPagination keyField={'id'} data={data} pageSize={1} />,
        );
    ...
    it('should pass the right data to Table', () => {
        const component = mount(<TableWithBrowserPagination keyField={'id'} />);
    ...
    it('should pass the right activePage to Pagination', () => {
        const component = mount(
            <TableWithBrowserPagination data={data} pageSize={2} keyField={'id'} />,
        );
    ...
    it('should pass the right value to Select', () => {
        const component = mount(
            <TableWithBrowserPagination data={data} pageSize={1} keyField={'id'} />,
        );
    ...
    it('should set the current activePage when data change dynamically and activePage is equal than pages amount', () => {
        const component = mount(
            <TableWithBrowserPagination data={data} pageSize={1} keyField={'id'} />,
        );
    ...
    it('should call getPageItems with the right data for second time when data change dynamically', () => {
    ...
    it('should call getPageItems with the right data when select a page option in select element', () => {
        ...
        expect(getPageItems).toHaveBeenCalledWith({
            activePage: 3,
            data,
            pageSize: 1,
        });
