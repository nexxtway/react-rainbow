...
##### rating with details
    ...
    const ratingCountStyles = { fontSize: '3rem' };
    ...
    <div className="rainbow-p-bottom_xx-large">
        ...
        <div className="rainbow-m-around_x-large">
            <Card
                icon={
                    <span className="rainbow-border-radius_circle rainbow-align-content_center" style={iconContainerStyles}>
                        <FontAwesomeIcon icon={faImages} size="lg" className="rainbow-color_white" />
                    </span>
                }
                title="Rainbow Gallery"
                footer={
                    <div className="rainbow-flex rainbow-justify_spread rainbow-m-top_xx-small rainbow-m-horizontal_medium rainbow-m-bottom_medium">
                        <div>
                            <h3 className="rainbow-font-size-heading_medium rainbow-color_dark-1">Give us your rate</h3>
                            <p className="rainbow-color_gray-3 rainbow-m-top_x-small" style={ratingCountStyles}>
                                992<span className="rainbow-font-size-heading_small rainbow-m-left_x-small rainbow-color_gray-4">Ratings</span>
                            </p>
                        </div>
                        <div style={detailContainerStyles}>
                            ...
                            <div className="rainbow-flex rainbow-flex_row rainbow-align_center rainbow-m-top_medium">
                                ...
                                <img src={smallStar} className="rainbow-m-left_xx-small" />
                                <img src={smallStar} className="rainbow-m-left_xx-small" />
                                <div className="rainbow-m-left_xx-small rainbow-background-color_gray-2" style={barStyles}>
                                    <span className="rainbow-background-color_gray-4" style={progressBarStyles} />
                                </div>
                            </div>
                ...
                <CarouselCard className="rainbow-m-around_xx-large" id="carousel-1" disableAutoScroll>
                    <CarouselImage
