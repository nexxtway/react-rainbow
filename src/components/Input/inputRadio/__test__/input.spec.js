...
describe('<InputRadio/>', () => {
    ...
    it('should fire an event when the user change the input', () => {
        ...
        const component = mount(
            <InputRadio onChange={onChangeFn} />,
        );
    ...
    it('should pass a generated id to the Error element and set the same id to the aria-describedby for the input when a error is passed', () => {
        const component = mount(
            <InputRadio error="error message" />,
        );
        expect(component.find('.rainbow-input-radio_error-message').prop('id')).toMatch(/error-message/);
    ...
    it('should have the right class name in the container element', () => {
        ...
        expect(component.find('div[className="rainbow-input-radio_container"]').exists()).toBe(true);
    });
    it('should have the right class names when error is passed', () => {
        const component = mount(
            <InputRadio error="Error text" />,
        );
        expect(component.find('div[className="rainbow-input-radio_container rainbow-input-radio--error"]').exists()).toBe(true);
    });
