...
function ErrorIcon({ inheritFillColor }) {
    const fillCircleColor = inheritFillColor ? 'currentColor' : '#FE4849';
    const fillColor = inheritFillColor ? 'currentColor' : '#EA4243';
...
ErrorIcon.propTypes = {
    inheritFillColor: PropTypes.bool,
};

ErrorIcon.defaultProps = {
    inheritFillColor: false,
};
