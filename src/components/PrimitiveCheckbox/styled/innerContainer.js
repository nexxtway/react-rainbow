...
const StyledInnerContainer = attachThemeAttrs(styled.div)`
    ...
    [type='checkbox'] + .rainbow-table-input-checkbox_faux::after,
    [type='checkbox'] ~ .rainbow-table-input-checkbox_faux::after,
    [type='checkbox'] + label .rainbow-table-input-checkbox_faux::after {
        ${props =>
            props.checked &&
            `
                display: block;
                ...
                border-bottom: 2px solid ${props.palette.brand.main};
                border-left: 2px solid ${props.palette.brand.main};
            `};
        ${props =>
