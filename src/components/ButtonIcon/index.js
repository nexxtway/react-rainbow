    ...
    render() {
        ...
        switch (variant) {
            ...
            case 'dropdownInverse':
                //This is because if a size prop if passed with another value, the dropdown button icon become a mess
                if ( size !== 'medium') {
...
ButtonIcon.propTypes = {
    ...
    /** The title that is showed when a user hover the icon. It is necessary if the button icon sits alone and a sighted user might need to hover for a description */
