...
describe('<Spinner/>', () => {
    ...
    it('should have the right class names when a custom class name is passed, variant is brand and size is large', () => {
        ...
        expect(
            component
                .find(
                    'div.rainbow-spinner.rainbow-spinner--brand.rainbow-spinner--large.custom-container-classname',
                )
                .exists(),
        ).toBe(true);
    });
    it('should have the right class names when variant is inverse and size is medium', () => {
        const component = mount(<Spinner variant="inverse" size="medium" />);
        expect(
            component
                .find('div.rainbow-spinner.rainbow-spinner--inverse.rainbow-spinner--medium')
                .exists(),
        ).toBe(true);
    });
    it('should have the right class names when variant is neutral and size is medium', () => {
        const component = mount(<Spinner variant="neutral" size="medium" />);
        expect(
            component
                .find('div.rainbow-spinner.rainbow-spinner--neutral.rainbow-spinner--medium')
                .exists(),
        ).toBe(true);
    });
    it('should have the right class names when size is small', () => {
        const component = mount(<Spinner size="small" />);
    ...
    it('should have the right class names when size is x-small', () => {
        const component = mount(<Spinner size="x-small" />);
    ...
    it('should have the right class names when size is xx-small', () => {
        const component = mount(<Spinner size="xx-small" />);
