...
describe('<MenuDivider />', () => {
    ...
    it('should set the right className to li element when variant default is passed', () => {
        const component = mount(
            <MenuDivider variant="default" />,
        );
        expect(component.find('li').prop('className')).toBe('slds-has-divider_top');
    });
    it('should set the right className to li element when variant space is passed', () => {
        const component = mount(
            <MenuDivider variant="space" />,
        );
        expect(component.find('li').prop('className')).toBe('slds-has-divider_top-space');
    });
});
