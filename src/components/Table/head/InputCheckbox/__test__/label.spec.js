...
describe('<InputCheckboxLabel/>', () => {
    ...
    it('should add the right class names when disabled is passed', () => {
        const component = mount(<Label label="Input Label" disabled />);
        expect(
            component
                .find(
                    '.rainbow-table-input-checkbox_label.rainbow-table-input-checkbox_label--disabled',
                )
                .exists(),
        ).toBe(true);
    });
    it('should add the right class names when hideLabel is passed', () => {
        ...
        expect(
            component
                .find(
                    '.rainbow-table-input-checkbox_label.rainbow-table-input-checkbox_label--hide',
                )
                .exists(),
        ).toBe(true);
    });
